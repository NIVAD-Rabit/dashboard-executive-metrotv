      ...
      {isLoading ? (
        ...
        <>
          ...
          <button
            ...
            className="fixed md:bottom-8 md:right-8 bottom-18 right-4 z-[40] flex items-center md:gap-3 gap-2 bg-primary text-primary-foreground md:px-6 px-4 py-2.5 rounded-full font-semibold md:font-bold hover:opacity-90 transition-all hover:-translate-y-1 hover:shadow-xl cursor-pointer shadow-lg"
          >
            <TableProperties className="md:size-[20px] size-[18px]" /> Input
          </button>
